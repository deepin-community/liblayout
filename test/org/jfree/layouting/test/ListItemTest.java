...
public class ListItemTest extends TestCase
{
  ...
  public ListItemTest(String string)
  {
    super(string);
  }
  ...
  private void createDocument()
  {
    ...
    documentList.add(FeedCommand.startDocument());
      documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "ol"));
        documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "li"));
        documentList.add(FeedCommand.addContent("Addddddddddddd"));
        documentList.add(FeedCommand.endElement());
        documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "li"));
        documentList.add(FeedCommand.addContent("Bdddddddddddd"));
        documentList.add(FeedCommand.endElement());
      documentList.add(FeedCommand.endElement());
