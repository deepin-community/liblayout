...
public class TableTest extends TestCase
{
  ...
  public TableTest(String string)
  {
    super(string);
  }
   ...
   * @throws org.jfree.layouting.layouter.feed.InputFeedException
   */
  ...
  private void createDocument()
  {
    ...
    documentList.add(FeedCommand.startDocument());
      documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "table"));
      documentList.add(FeedCommand.addContent(" ROOT"));
        documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "tbody"));
        documentList.add(FeedCommand.addContent("bbb"));
          documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "tr"));
          documentList.add(FeedCommand.addContent("aaa"));
            documentList.add(FeedCommand.startElement(Namespaces.XHTML_NAMESPACE, "td"));
            documentList.add(FeedCommand.addContent("ccccc"));
            documentList.add(FeedCommand.endElement());
          documentList.add(FeedCommand.addContent("sddddd"));
          documentList.add(FeedCommand.endElement()); // Close the TR
