 ...
 *
 * ------------
 * $Id: ListStylePositionResolveHandler.java 3524 2007-10-16 11:26:31Z tmorgner $
 * ------------
...
public class ListStylePositionResolveHandler extends ConstantsResolveHandler
{
   ...
   * @param style
   */
  public void resolve (final LayoutProcess process, final LayoutElement currentNode,
                       final StyleKey key)
  {
