 ...
 *
 * ------------
 * $Id: DefaultPageContext.java 3524 2007-10-16 11:26:31Z tmorgner $
 * ------------
...
public class DefaultPageContext implements PageContext
{
  ...
  public LayoutStyle getAreaDefinition(final PageAreaType name)
  {
    return (LayoutStyle) pageStyles.get(name);
  }

  public void setAreaDefinition(final PageAreaType area, final LayoutStyle style)
  {
   ...
   */
  public boolean isPseudoPage(final PseudoPage page)
  {
    return false;
  }
