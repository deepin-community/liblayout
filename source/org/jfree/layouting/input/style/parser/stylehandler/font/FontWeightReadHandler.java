 ...
 *
 * ------------
 * $Id: FontWeightReadHandler.java 3524 2007-10-16 11:26:31Z tmorgner $
 * ------------
...
public class FontWeightReadHandler implements CSSValueReadHandler
{
  ...
  public CSSValue createValue(final StyleKey name, final LexicalUnit value)
  {
    ...
    {
      if ("bolder".equalsIgnoreCase(value.getStringValue()))
      {
        return FontWeight.BOLDER;
      }
      if ("bold".equalsIgnoreCase(value.getStringValue()))
      {
        return FontWeight.BOLD;
      }
      if ("lighter".equalsIgnoreCase(value.getStringValue()))
      {
