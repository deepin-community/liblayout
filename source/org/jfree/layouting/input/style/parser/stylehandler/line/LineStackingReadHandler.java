 ...
 *
 * ------------
 * $Id: LineStackingReadHandler.java 3524 2007-10-16 11:26:31Z tmorgner $
 * ------------
...
public class LineStackingReadHandler implements CSSCompoundValueReadHandler
{
  ...
  {
    final CSSValue rubyValue = rubyReadHandler.createValue(null, unit);
    if (rubyValue != null)
    {
      unit = unit.getNextLexicalUnit();
    }

    final CSSValue shiftValue;
    if (unit != null)
    {
