 ...
 *
 * ------------
 * $Id: FontFamilyReadHandler.java 3524 2007-10-16 11:26:31Z tmorgner $
 * ------------
...
public class FontFamilyReadHandler extends ListOfValuesReadHandler
{
  ...
  protected CSSValue parseValue(final LexicalUnit value)
  {
    if (value.getLexicalUnitType() == LexicalUnit.SAC_IDENT)
    {
      if ("serif".equalsIgnoreCase(value.getStringValue()))
      {
        return FontFamilyValues.SERIF;
      }
      if ("sans-serif".equalsIgnoreCase(value.getStringValue()))
      {
        return FontFamilyValues.SANS_SERIF;
      }
      if ("fantasy".equalsIgnoreCase(value.getStringValue()))
      {
      ...
      if ("monospace".equalsIgnoreCase(value.getStringValue()))
      {
